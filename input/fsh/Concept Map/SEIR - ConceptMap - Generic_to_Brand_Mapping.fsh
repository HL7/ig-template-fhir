...
Usage: #definition
* meta.versionId = "1"
* meta.lastUpdated = "2025-06-12T08:33:03.392+00:00"
...
* group.element[=].target.display = "Pneumococcal Conjugate Vaccine, 13-Valent (adsorbed) [See formulation on reverse side]"
* group.element[=].target.equivalence = #equivalent
...
* group.element[=].target.display = "Inactivated Polio Vaccine (IPV)"
* group.element[=].target.equivalence = #equal
* group.element[+].code = #generic-mr
* group.element[=].display = "Measles Rubella"
* group.element[=].target.code = #SEIR-GenericName-00067
* group.element[=].target.display = "Measles Rubella"
* group.element[=].target.equivalence = #equal
